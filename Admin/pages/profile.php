...
<div class="profile-container">
    ...
    <div id="editProfileModal" class="edit-profile-modal">
        <div class="edit-profile-modal-content">
            <form id="editProfileForm" method="POST" action="<?= BASE_URL ?>/Admin/processes/update_profile.php" autocomplete="off">
    ...
    <div id="changePasswordModal" class="change-password-modal">
        <div class="change-password-modal-content">
            <form id="requestOtpForm" method="POST" action="<?= BASE_URL ?>/Admin/processes/OTP Processes/request_otp_change_password.php">
