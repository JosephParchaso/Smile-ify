        ...
        .then(data => {
            ...
            appointmentCard.innerHTML = `
                ...
                <div class="button-group button-group-profile">
                    <button class="confirm-btn" id="recordVitals">Record Vitals</button>
                    <button class="confirm-btn" id="recordPrescription">Record Prescription</button>
                    <button class="confirm-btn" id="markCancel">Cancel</button>
                </div>
            `;
