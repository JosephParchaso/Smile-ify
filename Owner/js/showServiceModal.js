            ...
            <form id="serviceForm" action="${BASE_URL}/Owner/processes/services/${isEdit ? "update_service.php" : "insert_service.php"}" method="POST" autocomplete="off">
                ...
                <div class="form-group">
                    <label class="confirmation-label">
                        ...
                        I understand that any updates made — including changes to service details, pricing, or availability —
                        may affect existing appointments or operations. I take responsibility to ensure that 
                        the <strong>Admin</strong> is notified about these changes.
                    </label>
