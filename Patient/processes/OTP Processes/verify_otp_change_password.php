...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_SESSION['otp']) || !isset($_SESSION['otp_created'])) {
        ...
        header("Location: " . BASE_URL . "/Patient/includes/OTP Includes/otp_verification_change_password.php");
        exit;
    }
    ...
    header("Location: " . BASE_URL . "/Patient/includes/OTP Includes/reset_password.php");
    exit;
}
